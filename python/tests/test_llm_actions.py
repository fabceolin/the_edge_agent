...
class TestOllamaExplicitProvider:
    ...
    def test_explicit_ollama_provider_uses_correct_base_url(self, engine, mock_openai_response, clear_env_vars):
    ...
    def test_explicit_ollama_provider_with_custom_api_base(self, engine, mock_openai_response, clear_env_vars):
    ...
    def test_explicit_openai_provider_uses_standard_client(self, engine, mock_openai_response, clear_env_vars):
...
class TestOllamaEnvVarDetection:
    ...
    def test_ollama_env_var_auto_detection(self, engine, mock_openai_response, clear_env_vars):
    ...
    def test_ollama_env_var_takes_priority_over_azure(self, engine, mock_openai_response, clear_env_vars):
    ...
    def test_azure_env_var_used_when_no_ollama(self, engine, mock_openai_response, clear_env_vars):
...
class TestProviderPriority:
    ...
    def test_explicit_provider_overrides_env_vars(self, engine, mock_openai_response, clear_env_vars):
    ...
    def test_default_to_openai_when_no_env_vars(self, engine, mock_openai_response, clear_env_vars):
...
class TestOllamaNoApiKey:
    ...
    def test_ollama_uses_dummy_api_key(self, engine, mock_openai_response, clear_env_vars):
    ...
    def test_ollama_no_cost_calculation(self, engine, mock_openai_response, clear_env_vars):
...
class TestOllamaStream:
    ...
    def test_stream_with_explicit_ollama_provider(self, engine, clear_env_vars):
        ...
        with mock_openai() as (mock_client, mock_module):
            ...
            mock_final_chunk.usage.model_dump = Mock(return_value={
                "prompt_tokens": 10,
                "completion_tokens": 5,
                "total_tokens": 15
            })

            mock_client.chat.completions.create.return_value = iter([mock_chunk, mock_final_chunk])
    ...
    def test_stream_ollama_no_cost(self, engine, clear_env_vars):
        ...
        with mock_openai() as (mock_client, mock_module):
            ...
            mock_chunk.usage.model_dump = Mock(return_value={
                "prompt_tokens": 10,
                "completion_tokens": 5,
                "total_tokens": 15
            })
...
class TestExistingFunctionalityUnchanged:
    ...
    def test_openai_still_works_without_provider_param(self, engine, mock_openai_response, clear_env_vars):
    ...
    def test_azure_still_works_with_env_vars(self, engine, mock_openai_response, clear_env_vars):
