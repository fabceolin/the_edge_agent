 ...
 * @returns {Promise<string>}
 */
export function game_generate_round_llm() {
    const ret = wasm.game_generate_round_llm();
    return ret;
}
 ...
 * @returns {string}
 */
export function game_get_phrase_database_info() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.game_get_phrase_database_info();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_20e39d469b5beced = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 973, function: Function { arguments: [], shim_idx: 974, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
    ...
    imports.wbg.__wbindgen_cast_6699488bd9b9abb8 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 1886, function: Function { arguments: [Externref], shim_idx: 1887, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
