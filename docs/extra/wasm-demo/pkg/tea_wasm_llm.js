...
function __wbg_adapter_18(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha822a74dc9a4a732(arg0, arg1, addHeapObject(arg2));
}
...
export function set_lua_callback(callback) {
    wasm.set_lua_callback(addHeapObject(callback));
}
...
export function set_llm_handler(handler) {
    wasm.set_llm_handler(addHeapObject(handler));
}
...
export function set_prolog_handler(handler) {
    wasm.set_prolog_handler(addHeapObject(handler));
}
...
function __wbg_adapter_56(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h1fc9b241df9e2ddd(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('tea_wasm_llm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
